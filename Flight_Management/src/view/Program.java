...
import model.Flight;
import model.Regex_Pattern;
import model.Reserve;
import gui.MainMenu;
import gui.TableOutputter;
import controller.FlightManagement;
import controller.ReserveManagement;
import controller.SeatRepo;
        ...
        while (true) {
            ...
            switch (mn.getOption()) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    Id = Inputter.getString("Input Flight Number to make Reserve:", "Invalid input!", "F\\d{4}");
