...
public class Inputter {
    ...
    public static String getName2(String msg, String v, int minLength, int maxLength) {
        String value = null;
        while (true) {
            try {
                System.out.println(msg);
    ...
    public static String getString2(String msg, String v) {
        String value;
        while (true) {
            try {
                System.out.println(msg);
     ...
     public static String getString2(String msg, String errMsg1, String v, String regex) {
        String value = null;
        while (true) {
            try {
                System.out.println(msg);
