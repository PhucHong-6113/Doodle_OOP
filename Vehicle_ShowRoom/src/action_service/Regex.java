...
//  Casual
    ...
    public static String nameRegex = "[a-zA-Z]{5,30}";
    public static String dateUpdateRegex = "^\\d{4}\\-(0[1-9]|1[012])\\-(0[1-9]|[12][0-9]|3[01])$";
    public static String yearRegex = "^\\d{4}$"; 
    

//  Private          
    public static String VehicleRegex = "V\\d{3}";
    public static String CusRegex = "C\\d{3}";
    public static String OrderRegex = "D\\d{3}";
